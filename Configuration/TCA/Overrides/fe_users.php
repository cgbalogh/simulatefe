...
if (!isset($GLOBALS['TCA']['fe_users']['ctrl']['type'])) {
    ...
    $tempColumnstx_simulatefe_fe_users = [];
    $tempColumnstx_simulatefe_fe_users[$GLOBALS['TCA']['fe_users']['ctrl']['type']] = [
        'exclude' => true,
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('fe_users', $tempColumnstx_simulatefe_fe_users);
}
...
$GLOBALS['TCA']['fe_users']['columns'][$GLOBALS['TCA']['fe_users']['ctrl']['type']]['config']['items'][] = ['LLL:EXT:simulatefe/Resources/Private/Language/locallang_db.xlf:fe_users.tx_extbase_type.Tx_Simulatefe_User','Tx_Simulatefe_User'];
